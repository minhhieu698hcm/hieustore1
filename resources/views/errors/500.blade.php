...
<div class="main-error-page">
    <div class="brand-logo">
                    <a href="{{URL::to($logo_main->link)}}" class="mobile-logo-link">
                                <img src="{{ asset('public/frontend/images/logo/unitek.webp') }}" alt=""
                                    class="mobile-logo-img" style="width: 100%;margin-bottom: 80px;">
                            </a>
                </div>
  <svg
  ...
  <h1 class="error-title">
    Úiiiii! <br>Có gì đó không ổn! :(
  </h1>
  <h2 class="error-subtitle">
   Bạn đã thử tắt và truy cập lại chưa?
  </h2>
