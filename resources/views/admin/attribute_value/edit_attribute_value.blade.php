            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="d-sm-flex align-items-center justify-space-between">
                        <h4 class="mb-4 mb-sm-0 card-title"> Cập nhật phân loại</h4>
                    ...
                    <div class="card-body">
                        <form action="{{URL::to('/submit-edit-attr-value/'.$select_attr_value->idAttrValue)}}" method="POST" data-toggle="validator">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="idAttribute" name="idAttribute" class="form-select"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="AttrValName" class="form-control"
                                    placeholder="Tên nhóm phân loại" value="{{$select_attr_value->AttrValName}}">
                            </div>
                            <div class="form-actions" style="text-align: center;">
                                <button type="submit" name="update_attribute" class="btn btn-primary"
                                    style="margin-top: 20px; padding: 20px; width:100%">Cập nhật phân loại</button>
                            </div>
