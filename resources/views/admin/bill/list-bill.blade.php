    ...
    <div class="row align-items-center">
      <div class="col-12">
        <div class="d-sm-flex align-items-center justify-space-between">
          <h4 class="mb-4 mb-sm-0 card-title">DANH SÁCH ĐƠN HÀNG</h4>
    ...
    <div class="card">
      <div class="card-body p-3">
        <div class="d-flex justify-content-between align-items-center gap-6 mb-9">
          <h4 class="row" style="margin-left: 0.5em;color: red;">Danh Sách Đơn hàng ( Tổng: {{$totalOrders}} )</h4>
          ...
          <table class="table align-middle mb-0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <!--<td>
                  <h6 class="mb-0 fs-4">
                    {{ $bill->idCustomer ? 'Người dùng' : 'Khách' }}
                  </h6>
                </td>-->
				<td>
                  <h6 class="mb-0 fs-4">
